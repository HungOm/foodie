...
40.times do 
    ...
    food = Food.create(name:Faker::Food.unique.dish,price:rand(11.2...76.9),ingredients:Faker::Food.ingredient,description:Faker::Food.description,menu_status:1,image_url:image_url[:image])
    if !food.valid?
